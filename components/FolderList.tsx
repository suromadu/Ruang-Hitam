      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        {allFolders.map((f) => (
          <button
            ...
            className="p-6 rounded-xl bg-gradient-to-br from-purple-900 to-pink-900 hover:from-purple-700 hover:to-pink-700 transition-all transform hover:scale-105 shadow-lg text-center font-semibold[...]"
          >
